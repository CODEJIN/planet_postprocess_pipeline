...
| **윈도우 (프레임 수)** | 3 | 1–9 (홀수 권장) | 슬라이딩 윈도우 스태킹 프레임 수입니다. 1 = 단일 프레임, 3 = 앞뒤 1개씩 포함(SNR √3 향상), 5 = 앞뒤 2개씩(SNR √5 향상). |
...
> **De-rotation 단계 자동 스킵**: TIF 파일 수가 de-rotation 윈도우 하나를 구성하기에 부족한 경우, Step 03~06 및 Step 08~10이 자동으로 건너뛰어지고 Step 07 (웨이블릿 미리보기)만 실행됩니다. 확인 다이얼로그에 발견된 파일 수 및 필요한 파일 수가 경고로 표시됩니다.
